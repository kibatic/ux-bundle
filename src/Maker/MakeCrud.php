...
//    use CanGenerateTestsTrait;
    ...
    {
        return 'Create CRUD for Doctrine entity class (but better)';
    }
...
//        $this->interactSetGenerateTests($input, $io);
    ...
    {
        $generateTemplatePath = \sprintf('%s/../templates/maker', \dirname(__DIR__));
        ...
        $generator->generateController(
            ...
            "$generateTemplatePath/crud/controller/Controller.tpl.php",
            array_merge([
        ...
        foreach ($templates as $template => $variables) {
            $generator->generateTemplate(
                ...
                "$generateTemplatePath/crud/templates/$template.tpl.php",
                $variables
            );
        }
